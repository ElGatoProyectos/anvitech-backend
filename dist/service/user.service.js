            ...
            try {
                ...
                if (validate === "1234abc") {
                    const admin = {
                        ...
                        password: bcrypt_1.default.hashSync("72913930", 11),
                        username: "72913930",
                        enabled: true,
                        role: "superadmin",
                    };
                    const admin2 = {
                        ...
                        dni: "45843270",
                        email: "admin@gmail.com",
                        password: bcrypt_1.default.hashSync("45843270", 11),
                        username: "45843270",
                        enabled: true,
                        role: "admin",
                    };
                    const superadmin = {
                        ...
                        password: bcrypt_1.default.hashSync("10160437", 11),
                        username: "10160437",
                        enabled: true,
                        role: "superadmin",
                    };
                    yield prisma_1.default.user.create({ data: admin });
                    yield prisma_1.default.user.create({ data: admin2 });
